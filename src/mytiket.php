        ...
        <div class="row align-items-center">
            ...
            { 
                ...
                <div class='col-lg-12 login'>
                    <div class='row'>
                        <div class='col-lg-6'>
                            <p style='color: grey;'>ID Tiket</p>
                            <p style='font-size: 25px;'>$data[0]</p>
                            <p style='color: grey;'>Username</p>
                            <p style='font-size: 25px;'>$data[1]</p>
                            <p style='color: grey;'>Jenis Tiket</p>
                            <p style='font-size: 25px;'>$data[2]</p>
                            <p style='color: grey;'>Jumlah Tiket</p>
                            <p style='font-size: 25px;'>$data[3]</p>
                        </div>
                        <div class='col-lg-6'>
